...
<!DOCTYPE html>
	<html>
		...
		<section>
            ...
            <p> Le site a pour vocation d'améliorer la gestion interne du pc (serveur de musique) ainsi que des différentes bases de données liées à ce dernier (bibliographiques, lithiques et référencement des sites archéologiques et des opérateurs)<br/>
        <strong> Le site est pour le moment en construction et sa structure est susceptible d'être modifier à l'avenir</strong></p>

		<fieldset> 
		<legend> Base multimédia </legend>
		<p> <h2>Base de donnée biblio</h2>
		...
		<p> <h2> Base de donnée des jeux vidéo </h2>
		...
		<p> <h2> Base de donnée des films </h2>
